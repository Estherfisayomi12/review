...
const fileValidation = (file) => {
	...
	if (!isValidFile) {
		document.querySelector('#file-error').innerHTML = 'You can only upload JPG/PNG/Docx/PDF file!';
		return false;
	}
...
const formValidation = () => {
	...
	if (coverLetterField.value === '') {
		document.querySelector('#cover-error').innerHTML = 'Cover letter is required';
	...
	if (allegianceField.checked === false) {
		document.querySelector('#allegiance-error').innerHTML = 'This field is required';
		return false;
	}
};
